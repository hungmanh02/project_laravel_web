    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="mb-3">
                ...
                <input type="number" name="epx" value="{{ old('epx')}}" class="form-control @error('epx') is-invalid @enderror" id="" placeholder="kinh nghiệm...">
                @error('epx')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                <div class="row align-items-end">
                    <div class="col-7">
                        ...
                        <input type="text" id="image"  readonly name="image" value="{{old('image')}}" class="form-control @error('image') is-invalid @enderror" id=""
