...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 18, 2023 at 05:09 PM
...
(7, '2023_03_28_062451_creat_categories_table', 1),
(8, '2023_04_14_052714_create_teachers_table', 1),
(9, '2023_05_18_165750_create_courses_table', 1),
(10, '2023_05_18_170018_create_categories_courses_table', 1);
...
ALTER TABLE `categories_courses`
  ADD CONSTRAINT `categories_courses_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`),
  ADD CONSTRAINT `categories_courses_course_id_foreign` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`);
